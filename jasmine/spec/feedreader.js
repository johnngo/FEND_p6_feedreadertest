...
$(function() {
    ...
    */
    ...
    /* TODO: Write a new test suite named "The menu" */
         ...
         */
         it('check that menu is hidden',function(){
          ...
          */
            it('menu hides and appears on menu icon click', function (){
                //when menu icon is clicked, menu list appears, menu-hidden class changes
